...
public class SortMapByValuesProgram5 {
	public static void main(String[] args) {
		...
		Map<Integer, String> sortedIdNameMap = idNameMap.entrySet().stream()
				.sorted(Entry.comparingByValue((o1, o2) -> o2.length() - o1.length()))

				// OR
				// .sorted(Collections.reverseOrder(Entry.comparingByValue((o1, o2) ->
				// o1.length() - o2.length())))
